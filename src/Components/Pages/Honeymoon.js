...
const Honeymoon = () => {
	return (
		<div
			className="w-full md:w-6/12 flex flex-col items-center page background-overlay"
		>
			<h2 className="text-6xl w-10/12 mx-auto mt-8 font-parisienne md:text-center">
				Honeymoon Fund
			</h2>
			...
			<div className="divider"></div>
            <p className='font-edu mb-4 w-full text-center'>Below are the links to our fund!</p>
			<div className="w-10/12 flex flex-col md:flex-row items-center justify-between">
